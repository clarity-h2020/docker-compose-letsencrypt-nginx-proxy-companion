# CLARTIY CSIS nginx reverse proxy
...
CLARTIY CSIS nginx reverse proxy is based on the [evertramos/docker-compose-letsencrypt-nginx-proxy-companion](https://github.com/evertramos/docker-compose-letsencrypt-nginx-proxy-companion) repository and has been cloned to maintain some [site-specific configuration](https://github.com/clarity-h2020/docker-compose-letsencrypt-nginx-proxy-companion/tree/csis.ait.ac.at/nginx-data/vhost.d).

## Deployment

nginx reverse proxy is deployed at `/docker/010-ngnix-proxy` both on [CSIS Development System](https://github.com/clarity-h2020/csis#csis-development-system) and [CSIS Production System](https://github.com/clarity-h2020/csis#csis-production-system) virtual servers.

### Configuration

#### nginx reverse proxy

Site specific configuration for [csis.ait.ac.at](https://github.com/clarity-h2020/docker-compose-letsencrypt-nginx-proxy-companion/tree/csis.ait.ac.at/nginx-data/vhost.d) and [csis-dev.ait.ac.at](https://github.com/clarity-h2020/docker-compose-letsencrypt-nginx-proxy-companion/tree/csis-dev.ait.ac.at/nginx-data/vhost.d) is maintained in two separate branches and stored in directory `nginx-data/vhost.d`.

An important option in [vhost.d/csis-dev.ait.ac.at](https://github.com/clarity-h2020/docker-compose-letsencrypt-nginx-proxy-companion/blob/csis-dev.ait.ac.at/nginx-data/vhost.d/csis-dev.ait.ac.at#L24) is for example:

```
add_header 'Access-Control-Allow-Origin' 'http://localhost:3000';
```

which allows [Map-](https://github.com/clarity-h2020/map-component#tests) and [Table-Component](https://github.com/clarity-h2020/simple-table-component#tests) that are usually deployed together with [docker-drupal](https://github.com/clarity-h2020/docker-drupal) to be tested locally.

#### proxied containers

The configuration of proxied containers like [docker-drupal](https://github.com/clarity-h2020/docker-drupal#configuring-and-starting-the-containers) can usually be found in the respective [.env file](https://github.com/clarity-h2020/docker-drupal/blob/dev/.env.sample), e.g for [csis-dev.myclimateservice.eu](http://csis-dev.myclimateservice.eu/):
...
The following myclimateservice.eu subdomains are currently in use:

- CSIS Development System [docker-drupal](https://github.com/clarity-h2020/docker-drupal) at [csis-dev.myclimateservice.eu](https://csis-dev.myclimateservice.eu/)
- CSIS Production System [docker-drupal](https://github.com/clarity-h2020/docker-drupal) at [csis.myclimateservice.eu](https://csis.myclimateservice.eu/)
- CKAN Catalogue [ckan](https://github.com/clarity-h2020/ckan) at [ckan.myclimateservice.eu](https://ckan.myclimateservice.eu/)
